...
#ifndef __mlThresholdImage_H
#define __mlThresholdImage_H


// Local includes
#include "DIAGImageThresholdSystem.h"
...
//! 
class DIAGIMAGETHRESHOLD_EXPORT ThresholdImage : public Module
{
public:
...
private:
  ...
  ML_MODULE_CLASS_HEADER(ThresholdImage)
};


ML_END_NAMESPACE

#endif // __mlThresholdImage_H