...
#ifndef __mlEqualizeHistogram_H
#define __mlEqualizeHistogram_H


// Local includes
#include "DIAGEqualizeHistogramSystem.h"
...
//! 
class DIAGEQUALIZEHISTOGRAM_EXPORT EqualizeHistogram : public Module
{
public:
...
private:
  ...
  ML_MODULE_CLASS_HEADER(EqualizeHistogram)
};


ML_END_NAMESPACE

#endif // __mlEqualizeHistogram_H